                            ...
                            <div style={{ marginBottom: 32 }}>
                                ...
                                <div style={{
                                    ...
                                    <div className="grid grid-cols-2 gap-3 mt-6">
                                        <button
                                            onClick={handlePhone}
                                            className="h-12 rounded-xl flex items-center justify-center gap-2 font-extrabold text-sm transition-all"
                            ...
                            <div style={{ marginBottom: 32 }}>
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                                    {normalizedPerfumes.length > 0 ? (
                                            ...
                                            return (
                                                <div
                                                    ...
                                                    style={{
                                                        ...
                                                        justifyContent: 'space-between',
                                                        padding: '14px 18px',
                                                        background: isGift ? 'linear-gradient(90deg, rgba(201,168,106,0.14) 0%, var(--surface) 100%)' : 'var(--surface)',
                                                        borderRadius: 16,
                                                        border: isGift ? '1px solid var(--gold)' : '1px solid var(--border)',
                                                ...
                                                >
                                                    <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
                                                        <div style={{
                                                            ...
                                                            background: isGift ? 'var(--gold)' : 'var(--surface-2)',
                                                            color: isGift ? '#111827' : 'var(--text-muted)',
                                                            display: 'flex', alignItems: 'center', justifyContent: 'center',
                                                    ...
                                                    {isGift && (
                                                        <div style={{
                                                            ...
                                                            color: '#111827', padding: '3px 8px', borderRadius: 8,
                                        ...
                                        <div style={{ textAlign: 'center', padding: 32, color: 'var(--text-muted)', fontSize: 13, background: 'var(--surface-2)', borderRadius: 16, border: '1px dashed var(--border)' }}>
                            ...
                            <div style={{
                                ...
                                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 20 }}>
                                    ...
                                    <div style={{ textAlign: 'right' }}>
                                        ...
                                        <div style={{ fontSize: 14, fontWeight: 900, textTransform: 'uppercase', background: 'rgba(255,255,255,0.08)', padding: '4px 12px', borderRadius: 8 }}>
                                            {order.source}
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div style={{
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <button
                                    ...
                                    className="h-14 rounded-2xl font-black text-sm transition-all disabled:opacity-50 disabled:hover:scale-100"
                                ...
                                <button
                                    ...
                                    className="h-14 rounded-2xl border-2 border-red-500 text-red-500 font-black text-sm transition-all disabled:opacity-50"
                                >
                                    ANNULER
                                </button>
                            </div>
                            ...
                            <select
                                className="h-12 w-full rounded-xl font-bold text-sm px-4 text-center cursor-pointer outline-none transition-colors"
                                style={{ border: '1px solid var(--border)', background: 'var(--surface-2)', color: 'var(--text)' }}
                                value={order.status}
